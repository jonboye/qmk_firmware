...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UC(0x20AC),          _______,          KC_MPRV,
        _______,          _______, _______, _______, _______, _______, UC(0x00D1), _______, _______, _______, UC(0x20AC),        _______, RGB_VAI, KC_MSTP,
